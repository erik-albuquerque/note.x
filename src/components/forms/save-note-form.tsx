    ...
    <form className="flex flex-1 flex-col">
      ...
      {isRecording ? (
        <button
          ...
          className=" flex w-full items-center justify-center gap-2 bg-zinc-900 py-4 text-center text-sm font-medium text-white outline-none transition-colors hover:bg-zinc-900/80"
        >
